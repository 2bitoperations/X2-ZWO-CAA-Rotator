//Copyright Software Bisque 2025

#ifndef SBERRORX_H
#define SBERRORX_H

/*!\brief A list of Software Bisque error codes is found in the file sberrorx.h.  \ingroup X2Errors*/
/*!\details Under X2, all methods return an error code. Return a value of zero on success (no error), otherwise return an error code from the list that best matches the situation. Try to avoid overusing generic codes like ERR_CMDFAILED when possible.\ingroup X2Errors*/
/** \addtogroup X2Errors Software Bisque Error Codes */
/** @{ */
...
#define ERR_PROTRACK_REQUIRED                             241                 //|Protrack is not on and must be. Go to the TPoint window, Protrack tab to turn it on.|
...
#define ENUM_ERR_PEC_FIT                                  573                 //|Error during PEC fit.|
#define ENUM_ERR_PEC_AFTER_WORSE                          574                 //|Train PEC failed, periodic error after correction is worse. (One plausible reason is the image scale you entered is incorrect, i.e., too large, double check it.)|
...
#define ERR_API_CPP_OLD                                   607                 //|The file API_CPP.DLL is old and not compatible with this program. Please obtain the latest API_CPP.DLL.|
...
#define ERR_SEC_KEY                                       613                 //|A required security key is not present.|
...
#define ERR_APPXISRUNNING                                 1301                //|AppX is running.  Please exit it and try to connect again.|
...
#define ERR_AP_CLUTCHAWAREERROR                           8040                //|This mount is not clutch aware.  The Mach2GTO, only, supports the Find Home operation.|
...
#define ERR_IOPTRON_SLEWERROR                             310                 //|The target object is either below the horizon, or slewing to this object will exceed the mount's limits.|


/** @} */ // End of addtogroup X2Errors
